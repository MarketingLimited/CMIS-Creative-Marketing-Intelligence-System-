...
ai_generators_classification:
  ...
  video_only_generation:  # تُنتج فيديو فقط (صوت يُضاف لاحقاً)
    - name: "Runway Gen-3"
      capabilities: ["فيديو سريع", "جودة جيدة", "نصوص محدودة", "تأثيرات VFX"]
      best_for: ["Product-Focused", "VFX/Cinematic", "مشاهد قصيرة"]
      audio: "يُضاف في المونتاج"
    
    - name: "Pika Labs"
      capabilities: ["ممتاز للمنتجات الثابتة", "حركات بسيطة", "VFX خفيفة"]
      best_for: ["Product-Focused", "food photography", "VFX"]
      audio: "يُضاف في المونتاج"
  ...
  ai_avatar_generators:  # مولدات أفاتار رقمي (Virtual Influencer)
    - name: "HeyGen"
      capabilities: ["أفاتار واقعي", "حوار متزامن", "100+ أصوات"]
      best_for: ["Virtual Influencer", "Educational", "Testimonials"]
      languages: ["عربي", "إنجليزي", "50+ لغة"]
    
    - name: "D-ID"
      capabilities: ["أفاتار من صورة", "حوار طبيعي", "سريع"]
      best_for: ["Virtual Influencer", "quick turnaround"]
    
    - name: "Synthesia"
      capabilities: ["أفاتار احترافي", "140+ أفاتار جاهز", "متعدد اللغات"]
      best_for: ["Corporate", "Educational", "Professional"]
````````````
