...
2. في قسم **Instructions** انسخ وألصق التعليمات التالية للنظام (System Prompt) لتعريف النموذج كـ *CMIS Orchestrator*:
...
3. ضمن **Knowledge** (المرفقات) قم بتحميل ملفات المشروع: `main.md` حتى `09_content_planning.md` لتصبح مرجعًا للنموذج.
...
2. في **System Instruction** ألصق نسخة Gemini من تعليمات *CMIS Orchestrator* التالية:
...
3. أرفق ملفات المعرفة `main.md` إلى `09_content_planning.md` في خانة Knowledge أو References.
...
## بنية الملفات
- `main.md` — إعداد النظام العام وخط الأنابيب.
