...
## **النطاق والمرجع الافتراضي — البحرين**
...
market_default:
  ...
  currency: "BHD"
  direction: "RTL"
  disclosure: "#إعلان"   # يُذكر في بداية المواد المرعية
  privacy_law: "قانون حماية البيانات الشخصية البحريني (مرسوم بقانون رقم 30 لسنة 2018)"
  intl_refs: ["GDPR","CCPA"]   # مرجع إرشادي لا يغني عن المحلي
```
