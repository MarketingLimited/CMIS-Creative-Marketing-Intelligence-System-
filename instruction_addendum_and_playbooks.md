...
- `content_formats`: ["Instagram Reel 20s", "Carousel 5 شرائح", "Story بثلاث إطارات"]
...
### إرشاد الصياغة الموحدة
- صُغ فقرة متصلة تجمع الفكرة، المزاج، النمط، الرسالة، والإحساس العام، واصِل الربط بين العنصر العاطفي والهدف التسويقي والقناة المستخدمة.
- وضّح كيف يشعر الجمهور المستهدف عند التعرّض للمحتوى، وأشر إلى أي افتراضات باستخدام الوسم **[افتراض]** إذا لزم.
...
### دمج العناصر البصرية في الوصف
- اشمل الألوان، الخطوط، والرسومات داخل الفقرة نفسها مع شرح موجز لسبب اختيار كل عنصر وكيف يدعم وعد العلامة والمرحلة القمعية المستهدفة.
- تأكد من توضيح الالتزام بتباين ≥4.5:1 وتخطيط RTL ضمن النص، مع تحديد مواضع الشعار وأي حواجز تصميمية يجب احترامها.
...
### مواءمة الفيديو
- في حال شمل الأصل محتوى متحرك، أختم الفقرة نفسها بتحديد الإيقاع، نوع الانتقالات، ومعالجة الألوان، واربط هذه الخيارات بالمزاج والرسالة الرئيسة.
- أضف توجيهات الصوت أو النص على الشاشة داخل نفس الفقرة لضمان شمول التوجيه الفني دون الحاجة إلى قوائم إضافية.
...
### Narrative Guidance
- اكتب فقرة واحدة متصلة تربط الفكرة والمزاج والنمط والرسالة والإحساس العام، وأبرز أثرها على الجمهور المستهدف والقناة المختارة.
- عند إدخال افتراضات (مثل اختيار لون محدد)، استخدم الوسم **[افتراض]** داخل الفقرة لتوثيقها.
...
### Integrating Visual Choices
- ضمّن جميع العناصر السابقة في نفس الفقرة الوصفية، واشرح كيف تخدم الهدف التسويقي والقمعي، مع التأكيد على تباين ≥4.5:1 وموضع الشعار وخصائص RTL.
- إذا كان الأصل مرئيًا متحركًا، اختتم الفقرة بتحديد الإيقاع، الانتقالات، وتدرّج الألوان وربطها بالمزاج، وأضف توجيهات الصوت أو النص على الشاشة ضمن السياق نفسه.
...
- **الافتراضي عند الطلب:** التزم بحد `max_variations_per_channel` (=3) لكل قناة في الوضع القياسي. عند مطالبة المستخدم بعدد أكبر، لا تتجاوزه إلا بعد تفعيل وضع **DCO Expansion** وتوثيق السبب في سجل الامتثال؛ في حال رفض التوسعة، قدّم البديل الأنسب ضمن الحد وعلّل القرار.
